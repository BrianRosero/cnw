...
import logo from '../../../../assets/images/ssofialogo.png'

// Importar componentes de páginas
import Rendimiento from '../../../../views/pages/COSMITET/SSOFIA/Sensors.jsx'
import INICIO from '../../../../views/pages/COSMITET/SSOFIA/Inicio.jsx'
...
const styles = {
  ...
  appBar: {
    backgroundColor: '#0693e3', // Color de fondo del appbar
    borderRadius: '8px',
    position: 'auto',
  },
  toolbar: {
        ...
        {currentPage ? (
          ...
          <Grid container spacing={3} css={styles.section}>
            ...
            <Grid container spacing={3} css={styles.section}>
              <Grid item xs={12} >
                <CardContent >
                  <Typography variant="h2" align="center" style={{color: '#0033a0'}}>¡Bienvenido al Panel de Control de Servicios CLINICA SANTA SOFÍA DEL PACÍFICO</Typography>
                </CardContent>
              </Grid>
            </Grid>
            ...
            <Grid container spacing={3} css={styles.section}>
              <Grid item xs={12}>
                <Typography variant="h4" align="center" id="servicios" style={{color: '#0033a0'}}>Servicios</Typography>
              </Grid>
              <Grid item xs={12} md={4}>
                <Card css={styles.card}>
                  <CardContent onClick={() => handleButtonClick('rendimiento')}>
                    <Typography variant="h5" css={styles.cardTitle}>Vizualizar el Rendimiento</Typography>
