...
import logo from '../../../../assets/images/cosmitet-logo-blanco.png'
...
const styles = {
  ...
  appBar: {
    backgroundColor: '#009100', // Color de fondo del appbar
    borderRadius: '8px',
    position: 'auto',
  },
  toolbar: {
        ...
        {currentPage ? (
          ...
          <Grid container spacing={3} css={styles.section}>
            ...
            <Grid container spacing={3} css={styles.section}>
              <Grid item xs={12} >
                <CardContent >
                  <Typography variant="h2" align="center">¡Bienvenido al Panel de Control de Servicios COSMITET LTDA</Typography>
                </CardContent>
              </Grid>
            </Grid>
