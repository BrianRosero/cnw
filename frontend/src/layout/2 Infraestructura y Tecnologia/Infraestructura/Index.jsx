...
function RealtimeMonitoring({ onGoToHome }) { // Asumo que recibirás esta prop para volver al inicio
  ...
  return (
    <Box sx={{ flexGrow: 1, bgcolor: '#eef2f6', minHeight: '100vh', color: '#fff', pb: 4 }}>
      {/* AppBar */}
      <AppBar position="static" elevation={0} sx={{ bgcolor: '#004a8f', borderBottom: '1px solid rgba(129, 212, 250, 0.1)' }}>
        <Toolbar>
          ...
          <MonitorHeartIcon sx={{ fontSize: 36, mr: 1, color: '#fff' }} />
      ...
      <Container maxWidth="xl" sx={{ mt: 4 }}>
        ...
        <Paper elevation={8} sx={{ p: 4, mb: 4, bgcolor: '#ffffff', border: '1px solid #ef5350' }}>
          ...
          <Divider sx={{ mb: 2, bgcolor: 'rgba(241,201,200,0.3)' }} />
          {activeAlerts.length === 0 ? (
            ...
            <List dense sx={{ maxHeight: 150, overflowY: 'auto' }}>
              {activeAlerts.map(alert => (
                <ListItem key={alert.id} sx={{ mb: 1, borderLeft: `4px solid ${alert.severity === 'error' ? '#ef5350' : '#ffab40'}`, p: 1, bgcolor: 'rgb(255,255,255)' }}>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={6} lg={4}>
            <Paper elevation={8} sx={{ p: 3, height: '100%', display: 'flex', flexDirection: 'column', bgcolor: '#ffffff' }}>
              <Box display="flex" alignItems="center" mb={2}>
          ...
          <Grid item xs={12} lg={12}>
            <Paper elevation={8} sx={{ p: 3, bgcolor: '#ffffff' }}>
              <Box display="flex" alignItems="center" mb={2}>
