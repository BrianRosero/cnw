                      ...
                      <Grid container alignItems="center">
                        ...
                        <Grid item xs={8}>
                          <SoftBox lineHeight={1}>
                            ...
                            <SoftTypography
                              variant="body2"
                              sx={{ color: host.power_state === 'on' ? '#59af41' : 'red' }}
                            >
                        ...
                        <Grid item xs={4}>
                          <SoftBox
                            variant="gradient"
                            sx={{ backgroundColor: "#59af41", color: "white" }} // Aplica el color de fondo correctamente
                            width="3rem"
                            height="3rem"
                            marginLeft="auto"
                            borderRadius="md"
                            ...
                            alignItems="center"
                            boxShadow={3} // Reemplaza "shadow" por la sintaxis correcta de Material-UI
                          >
