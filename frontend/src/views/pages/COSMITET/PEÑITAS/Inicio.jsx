...
import logo from '../../../../assets/images/peñitaslogo.png'

// Importar componentes de páginas
import Rendimiento from '../../../../views/pages/COSMITET/PEÑITAS/Sensors.jsx'
import INICIO from '../../../../views/pages/COSMITET/PEÑITAS/Inicio.jsx'
              ...
              <div style={styles.menuLinks}>
                <div style={styles.menuLinks}>
                  <MenuItem onClick={handleClose} style={styles.menuItem}>
                    <Link color="inherit" onClick={onBackButtonClick} style={{color:'#009240'}}>
                      Inicio
                    </Link>
                  </MenuItem>
                  {/*<MenuItem onClick={handleClose} style={styles.menuItem}>
        ...
        {currentPage ? (
          ...
          <Grid container spacing={3} css={styles.section}>
            ...
            <Grid container spacing={3} css={styles.section}>
              <Grid item xs={12} >
                <CardContent >
                  <Typography variant="h2" align="center" style={{color:'#5E7775'}}>¡Bienvenido al Panel de Control de Servicios la CLINICA LAS PEÑITAS S.A.S</Typography>
                </CardContent>
              </Grid>
            </Grid>
            ...
            <Grid container spacing={3} css={styles.section}>
              <Grid item xs={12}>
                <Typography variant="h1" align="center" id="servicios" style={{color:'#009240'}}>Servicios</Typography>
              </Grid>
