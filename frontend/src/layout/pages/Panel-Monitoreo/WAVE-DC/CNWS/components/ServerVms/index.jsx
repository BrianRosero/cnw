...
export default function VMDashboard() {
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await fetch('http://192.168.200.155:8083/vcenter/vms1');
  ...
  const groupVMs = (data) => {
    ...
    data.forEach((vm) => {
      ...
      else if (name.includes('CCC')) groups['CAMARA DE COMERCIO CALI'].push(vm);
      else if (name.includes('DUMI')) groups.DUMIAN.push(vm);
              ...
              <Grid container spacing={1}>
                  ...
                  <Box sx={{ px: 1 }}>
                    ...
                    >
                      ...
                      <Chip
                        ...
                        sx={{
                          my: 1,
                          backgroundColor: selectedVM.power_state === 'poweredOn' ? '#59af41' : '#ff0000', // Verde HP GreenLake y rojo error
                        ...
                        {selectedVM.network_adapters.map((nic, i) => (
                          <Box key={i} mb={2}>
                            ...
                            <Chip
                              ...
                              sx={{
                                my: 1,
                                backgroundColor: nic.connected ? '#59af41' : '#ff0000', // Verde personalizado y rojo por defecto
                                color: 'white', // Asegura que el texto sea legible
                              }}
                            />
                ...
                <Grid item xs={12} md={6}>
                  <Box sx={{ px: 1 }}>
                    ...
                    <Chart
                      options={gaugeChartOptions('CPU', '#59af41')}
                ...
                <Grid item xs={12} md={6}>
                  <Box sx={{ px: 1 }}>
                    ...
                    <Chart
                      options={gaugeChartOptions('Memoria', '#59af41')}
