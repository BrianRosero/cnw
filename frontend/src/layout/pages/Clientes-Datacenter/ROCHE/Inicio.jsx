...
import logo from '@/assets/images/ROCHE.png'
...
const styles = {
  ...
  cardTitle: css`
      margin: 0;
      color: #000000;
      font-family: 'SF-Heading-font', sans-serif;
      font-size: 30px;
      font-weight: 400;
      letter-spacing: 0;
  `,
  cardDesc: css`
      margin: 14px 0 0;
      color: #666666;
      font-family: 'SF-Body-font', sans-serif;
      font-size: 17px;
      font-weight: 400;
      letter-spacing: 0;
  `,
        ...
        {currentPage ? (
          ...
          <Grid container spacing={3} css={styles.section}>
            ...
            <Grid container spacing={3} css={styles.section}>
              <Grid item xs={12} >
                <CardContent >
                  <Typography css={styles.section1} variant="h2" align="center">¡Bienvenido al Panel de Control de Servicios de ROCHE COLOMBIA </Typography>
                </CardContent>
              </Grid>
            </Grid>
            ...
            <Grid container spacing={3} css={styles.section}>
              <Grid item xs={12}>
                <Typography css={styles.section2} variant="h4" align="center" id="servicios">Servicios</Typography>
              </Grid>
              <Grid item xs={12} md={4}>
                <Card css={styles.card}>
                  <CardContent onClick={() => handleButtonClick('rendimiento')}>
                    <Typography variant="h2" css={styles.cardTitle}>Rendimiento</Typography>
                    <Typography css={styles.cardDesc} variant="h4" >
