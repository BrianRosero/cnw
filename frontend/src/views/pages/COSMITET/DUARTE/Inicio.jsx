...
import logo from '../../../../assets/images/duartelogo.png'
        ...
        {currentPage ? (
          ...
          <Grid container spacing={3} css={styles.section}>
            ...
            <Grid container spacing={3} css={styles.section}>
              <Grid item xs={12} >
                <CardContent >
                  <Typography style={{color: '#2154ac'}} variant="h2" align="center">¡Bienvenido al Panel de Control de Servicios de CAMARA DE COMERCIO DE CALI </Typography>
                </CardContent>
              </Grid>
            </Grid>
            ...
            <Grid container spacing={3} css={styles.section}>
              <Grid item xs={12}>
                <Typography style={{color: '#2154ac'}} variant="h4" align="center" id="servicios">Servicios</Typography>
              </Grid>
